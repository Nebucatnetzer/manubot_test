...
[@url:https://www.borgbackup.org/], durchzuführen sowie zu dokumentieren.
...
[@url:https://creativecommons.org/licenses/by-sa/4.0] Lizenz. Dadurch darf die
...
BorgBackup steht unter einer BSD [@url:https://opensource.org/licenses/BSD-3-Clause]
...
Commit Message“ [@url:https://chris.beams.io/posts/git-commit] und in
...
semantische Versionierung [@url:https://semver.org] verwendet werden. Dabei ist
...
Als Software für die Versionskontrolle wurde Git [@url:https://git-scm.com/]
...
hauptsächlich der Editor GNU Emacs [@url:https://www.gnu.org/software/emacs/]
...
Diese Dokumentation wurde in Org-mode [@url:https://orgmode.org/], einer
...
LaTeX [@url:https://www.latex-project.org/] ist eine Software, welche einem die
...
Editor Inkscape [@url:https://inkscape.org/en/] erstellt. Inkscape ist Freie Software
unter der GNU Public License v3.

Die Diagramme wurden mit Draw.io [@url:https://www.draw.io] erstellt. Draw.io
ist Freie Software unter Apache Lizenz Version 2.0
[@url:https://www.apache.org/licenses/LICENSE-2.0] und kann sowohl als Desktop
...
[@url:https://practicaltypography.com] angewandt. Bei den Diagrammen wurden
ausschliesslich Farben aus der von Google entwickelten Design Sprache
„Material“ [@url:https://www.materialui.co/colors] eingesetzt.
...
dar.“[@url:https://de.wikipedia.org/wiki/Anwendungsfalldiagramm]
...
* Für das Erstellen von Archiven `borg create` [@url:https://borgbackup.readthedocs.io/en/stable/usage/create.html].
* Für das Anzeigen der Archiven `borg list` [@url:https://borgbackup.readthedocs.io/en/stable/usage/list.html].
* Für das Wiederherstellen der Archive `borg extract` [@url:https://borgbackup.readthedocs.io/en/stable/usage/extract.html].
* Für das Löschen der Archive `borg delete` [@url:https://borgbackup.readthedocs.io/en/stable/usage/delete.html].
* Zum Mounten der Archive `borg mount` [@url:https://borgbackup.readthedocs.io/en/stable/usage/mount.html#borg-umount].
* Zum Unmounten der Archive `borg umount` [@url:https://borgbackup.readthedocs.io/en/stable/usage/mount.html#borg-umount].
* Zum anzeigen der Repository Statistik `borg info` [@url:https://borgbackup.readthedocs.io/en/stable/usage/info.html].
...
[@url:https://github.com/dotnet/coreclr/blob/master/LICENSE.TXT], der aktuelle
Compiler Roslyn ist unter der Apache Lizenz verfügbar
[@url:https://github.com/dotnet/roslyn/blob/master/License.txt]. Da es sehr
...
1998 Teil des ISO Standards [@url:https://www.iso.org/standard/25845.html].
ISO/IEC 14882:2017 [@url:https://www.iso.org/standard/68564.html] ist zurzeit
...
[@url:https://docs.python.org/3/license.html] und wird durch die Python
...
geschrieben wird [@url:https://www.python.org/dev/peps/pep-0008/#a-foolish-consistency-is-the-hobgoblin-of-little-minds].
...
Qt [@url:https://doc.qt.io/qt-5/index.html], „cute“ ausgesprochen, ist ein
...
v3 [@url:https://doc.qt.io/qt-5/lgpl.html] oder mit einer kostenpflichtigen
...
[@url:https://gitlab.gnome.org/GNOME/gtk#licensing-terms]. Gtk ist ein Projekt
...
Applikation Meld [@url:http://meldmerge.org] zu sehen, wenn man eine Datei auswählen möchte,
Abbildung:(@fig:meld).

![Screenshot der Applikation Meld unter Windows 10](images/meld.png){#fig:meld}

Die Gtk Dokumentation empfiehlt
[@url:https://www.gtk.org/download/windows.php], dass man unter Microsoft
...
[@url:https://www.ubuntu.com] Linux, mit der GNOME Desktop Umgebung
[@url:https://www.gnome.org], als Betriebssystem. Die Tests werden jeweils
...
Time“[@url:https://github.com/bit-team/backintime] verglichen. „Back in Time“
...
[@url:https://feathericons.com] ausgewählt. Dabei handelt es sich um ein freies
...
Abhilfe schaffte hier ein Stackexchange Post [@url:https://stackoverflow.com/questions/335695/lists-in-configparser/9735884#9735884]. Dieser schlug vor,
...
[@url:https://docs.python.org/3.6/library/threading.html], mit. In der Praxis
...
dem PyQt Modul `QThread` [@url:https://doc.qt.io/qt-5/qthread.html] gemacht.
...
`subprocess` [@url:https://docs.python.org/3.6/library/subprocess.html]
...
Stackoverflow [@url:https://stackoverflow.com/a/14822210/7723859] übernommen.
...
[@url:https://github.com/borgbackup/borg/issues/768]. BorgBackup kann mehrere Archive gleichzeitig mounten. Der User
...
[@url:https://en.wikipedia.org/wiki/Systemd]. Die Prozesse werden über
...
[@url:https://jlk.fjfi.cvut.cz/arch/manpages/man/systemd.time.7]. In Borg-Qt
...
„PyInstaller“[@url:https://www.pyinstaller.org] erstellt. PyInstaller wird auf
